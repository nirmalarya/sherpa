...
function CommandPalette({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-[20vh] animate-fadeIn" onClick={handleClose}>
      <div
        ref={modalRef}
      ...
      >
            ...
            <div className="py-2">
              {filteredCommands.map((command, index) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`h-5 w-5 mr-3 ${isSelected ? 'text-primary-600' : 'text-gray-400'}`} />
        ...
        <div className="border-t border-gray-200 px-4 py-2 bg-gray-50 text-xs text-gray-500 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <span><kbd className="px-2 py-1 bg-white border border-gray-300 rounded">↑</kbd> <kbd className="px-2 py-1 bg-white border border-gray-300 rounded">↓</kbd> Navigate</span>
            <span><kbd className="px-2 py-1 bg-white border border-gray-300 rounded">↵</kbd> Select</span>
