      ...
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          <Routes>
            ...
            <Route path="/sessions" element={<div className="p-8"><h1 className="text-3xl font-bold">Sessions Page</h1></div>} />
            <Route path="/knowledge" element={<div className="p-8"><h1 className="text-3xl font-bold">Knowledge Page</h1></div>} />
            <Route path="/sources" element={<div className="p-8"><h1 className="text-3xl font-bold">Sources Page</h1></div>} />
          </Routes>
        </main>
